...
public class RassdInstructionsBuilder : EditorWindow
{
    ...
    const string TXT_HOW1        = "A stimulus appears briefly above or below the cross.";
    const string TXT_HOW2        = "Press Space only when the coffee appears above the cross.";
    const string TXT_HOW3        = "Do not press anything for anything else.";
    ...
    const string TXT_EASY_SUB   = "Coffee only, stay alert.";
    const string TXT_HARD        = "Hard";
    const string TXT_HARD_SUB   = "Other objects added, full focus needed.";
    ...
    const float FS_CARD_SB = 17f;
        ...
        [MenuItem("Tools/Rassd/Build Instructions UI")]
    static void Build()
    {
        ...
        Debug.Log("[RassdInstructionsBuilder] Done!");
        EditorUtility.DisplayDialog("Done", "Rassd Instructions UI built successfully!", "OK");
    }
